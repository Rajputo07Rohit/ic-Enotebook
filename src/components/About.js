...
const About = () => {
  ...
  return (
    <div>
    <h1>About Us</h1>
    <h3 className="text-primary">iNotebook - Your notebook on the cloud</h3>
    <p>This is iNotebook . You can use it to save your important notes. The notes will be saved in the cloud. You notes are secured on the cloud. You can edit your notes. Also you can delete. you can create your multiple accounts and sign in with your details. you can view your information in the settings page.</p>
